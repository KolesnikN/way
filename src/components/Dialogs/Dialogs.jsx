...
const Dialogs = (props) => {
    ...
    let dialogElement = props.dialogs.map(dialogs => <Dialog id={dialogs.id} name={dialogs.name}/>)
    let messageElements = props.messages.map(messages => <MyMessages message={messages.message}/>)
